    ...
    <Swiper
      ...
      <SwiperSlide>
        <div className="max-h-[38rem] relative">
          <div className="absolute inset-0 flex flex-col items-start justify-end bg-clr-darker bg-opacity-35">
      ...
      <SwiperSlide>
        <div className="max-h-[38rem] relative">
          <div className="absolute inset-0 flex flex-col items-end justify-end bg-clr-darker bg-opacity-35">
