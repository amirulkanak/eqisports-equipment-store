...
const Footer = () => {
  return (
    <>
      <footer className="mt-auto bg-gray-100 dark:bg-gray-800 pb-4 pt-20 lg:pt-[120px]">
        <div className="max-width-wrapper">
          <div className="flex flex-wrap">
            <div className="w-full sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <Link to={'/'}>
                  <h2 className="text-xl mb-6 font-bold font-playwrite">
                    <span className="text-sky-700 dark:text-sky-500">Equi</span>
                    Sports
                  </h2>
                </Link>
                <p className="mb-7 text-base text-body-color">
                  We are a team of sports enthusiasts who love to play sports
                  and help others to get the best sports equipment.
                </p>
            ...
            <LinkGroup header="Quick Links">
              <CustomNavLink label="Be a Sponsor" />
              <CustomNavLink label="Our Brands" />
              <CustomNavLink label="Brand Ambassador" />
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <ul className="mb-6 flex items-center">
                  <li className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-solid dark:border-clr-light border-sky-600/70 hover:bg-sky-500 hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                    <Link
                      target="_blank"
                ...
                <p className="text-base text-body-color dark:text-dark-6">
                  &copy; {new Date().getFullYear()} EquiSports
                </p>
              </div>
            </div>
          </div>
        </div>
        <div className="text-center text-clr-dark/50 dark:text-clr-light/50 pt-4 border-t border-clr-dark/30 dark:border-t-sky-600/30">
          Designed and developed by{' '}
          <Link
            to="https://github.com/amirulkanak"
            className="italic underline text-sky-600/70">
            Amirul Kanak
          </Link>
        </div>
      </footer>
